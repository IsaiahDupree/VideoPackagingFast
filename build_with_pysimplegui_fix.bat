@echo off
echo ===================================================
echo VideoPackagingFast - Build Script with PySimpleGUI Fix
echo ===================================================
echo.
...
REM Run the PySimpleGUI fix script
echo Fixing PySimpleGUI installation...
python fix_pysimplegui.py
if %ERRORLEVEL% NEQ 0 (
    echo Warning: PySimpleGUI fix script failed
    echo Trying alternative installation method...
    pip install PySimpleGUI==5.0.0.16 -i https://PySimpleGUI.net/install
)
...
REM Create wrapper directory in case it's needed
