@echo off
echo ===================================================
echo VideoPackagingFast - Improved Build Script
echo ===================================================
echo.
...
REM Install dependencies in the correct order to avoid conflicts
...
REM Install PySimpleGUI with a specific version that doesn't have RSA conflicts
echo Installing PySimpleGUI with compatible version...
