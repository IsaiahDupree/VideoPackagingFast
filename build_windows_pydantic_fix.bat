@echo off
echo ===================================================
echo VideoPackagingFast - Windows Build Script (Pydantic Fix)
echo ===================================================
echo.
...
pip install PyInstaller==5.6.2 pyinstaller-hooks-contrib==2022.0

REM Run the build issue fix script
echo Running build issue fix script...
python fix_build_issues.py
if %ERRORLEVEL% NEQ 0 (
    echo Warning: Build issue fix script failed
