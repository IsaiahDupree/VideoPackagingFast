@echo off
echo ===================================================
echo VideoPackagingFast - Windows Simple Build Script
echo ===================================================
echo.
...
REM Build the executable with the simplified spec file
echo Building executable with PyInstaller using simplified spec...
pyinstaller --clean VideoProcessor_windows_simple.spec
